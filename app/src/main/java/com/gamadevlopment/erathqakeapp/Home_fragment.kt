...
class Home_fragment(val mContext: Context, val listner: recyclerAdapter.onCardClickListner) :
    ...
    lateinit var earthQuake_rangeSelection_layout: LinearLayout
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        earthQuake_rangeSelection_layout = view.findViewById(R.id.homeFragment_date_range_select)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            try {
                getDataFromAPI("https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2022-01-01&endtime=2022-01-02")
            } catch (e: Error) {
                Log.d("Home_Fragment", "Error in geting data from api message: ${e.message}")
            }
        }
    ...
    fun getDataFromAPI(url: String) {
        try {
            ...
            Log.d("Home_Fragment", "Error from api message:  ${e.message}")
        }
